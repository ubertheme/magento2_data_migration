...
class Mage2CatalogProductLinkAttributePeer extends Mage2ActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'catalogProductLinkAttributeDecimals' => array(self::HAS_MANY, 'CatalogProductLinkAttributeDecimal', 'product_link_attribute_id'),
			'catalogProductLinkAttributeInts' => array(self::HAS_MANY, 'CatalogProductLinkAttributeInt', 'product_link_attribute_id'),
			'catalogProductLinkAttributeVarchars' => array(self::HAS_MANY, 'CatalogProductLinkAttributeVarchar', 'product_link_attribute_id'),
		);
	}
