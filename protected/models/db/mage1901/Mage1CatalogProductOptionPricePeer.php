...
class Mage1CatalogProductOptionPricePeer extends Mage1ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('option_price_id, option_id, store_id, price, price_type', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('option_price_id',$this->option_price_id,true);
