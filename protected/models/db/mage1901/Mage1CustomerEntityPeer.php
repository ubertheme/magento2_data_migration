...
class Mage1CustomerEntityPeer extends Mage1ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('entity_id, entity_type_id, attribute_set_id, website_id, email, group_id, increment_id, store_id, created_at, updated_at, is_active, disable_auto_group_change', 'safe', 'on'=>'search'),
		);
	}
