...
class MigrateController extends Controller
{
    ...
    public function actionTest(){
        //echo Yii::app()->mage1->tablePrefix;
//        $blackLists = array(
//            'custom_design' => MigrateSteps::getMage1AttributeId('custom_design', 3),
//            'custom_design_from' => MigrateSteps::getMage1AttributeId('custom_design_from', 3),
//            'custom_design_to' => MigrateSteps::getMage1AttributeId('custom_design_to', 3),
//            'page_layout' => MigrateSteps::getMage1AttributeId('page_layout', 3),
//            'custom_layout_update' => MigrateSteps::getMage1AttributeId('custom_layout_update', 3),
//            'custom_apply_to_products' => MigrateSteps::getMage1AttributeId('custom_apply_to_products', 3),
//            'custom_use_parent_settings' => MigrateSteps::getMage1AttributeId('custom_use_parent_settings', 3),
//        );
//        var_dump($blackLists);
//
//        if (in_array('62', $blackLists)){
//            echo 'Yes';
//        }

//        $str = 'a:1:{s:11:"category_id";s:1:"5";}';
//        var_dump(unserialize($str));

        // get all product attributes user defined
//        $condition = "entity_type_id = 4";
//        $attributes = Mage1Attribute::model()->findAll($condition);
//        $condition = "entity_type_id = 4";
//        $attributes2 = Mage2Attribute::model()->findAll($condition);
//        echo count($attributes)."|".count($attributes2)."|<br/>";
//        foreach ($attributes as $attribute){
//            $attributeId2 = MigrateSteps::getMage2AttributeId($attribute->attribute_id, 4);
//            if (!$attributeId2)
//                echo $attribute->attribute_code."|".$attribute->attribute_id."|".$attributeId2."<br/>";
//        }

//        foreach ($attributes2 as $attribute){
//            if (!Mage1Attribute::model()->find("attribute_code = '{$attribute->attribute_code}'")){
//                echo $attribute->entity_type_id."|".$attribute->attribute_code."<br/>";
//            }
//        }

//        $condition = "entity_type_id = 3";
//        $attributes = Mage1Attribute::model()->findAll($condition);
//        $condition = "entity_type_id = 3";
//        $attributes2 = Mage2Attribute::model()->findAll($condition);
//        echo count($attributes)."|".count($attributes2)."<br/>";
//        foreach ($attributes as $attr){
//            if (!Mage2Attribute::model()->find("entity_type_id = 3 AND attribute_code = '{$attr->attribute_code}'")){
//                echo $attr->attribute_id."|".$attr->attribute_code;
//            }
//        }
//        die();

//        $catalog_eav_attributes = Mage1CatalogEavAttribute::model()->findAll();
//        $catalog_eav_attributes2 = Mage2CatalogEavAttribute::model()->findAll();
//        echo count($catalog_eav_attributes)."|".count($catalog_eav_attributes2);

//        $categoryTree = MigrateSteps::getMage1CategoryTree(2);
//        echo count($categoryTree);

//        $models = Mage1CatalogProductEntityInt::model()->findAll();
//        foreach ($models as $model){
//            $attr_code = MigrateSteps::getMage1AttributeCode($model->attribute_id);
//            $attr_id2 = MigrateSteps::getMage2AttributeId($model->attribute_id, 4);
//            if (!$attr_id2){
//                echo $model->attribute_id."|{$attr_code}|".$attr_id2."<br/>";
//            }
//        }
    }
